...
extern uint64 MemFreeBootTime;
extern uint64 MemFreeYellow;
extern uint64 MemFreeRed;
extern uint MemFreePercentBootTime;
extern uint MemFreePercentYellow;
extern uint MemFreePercentRed;
